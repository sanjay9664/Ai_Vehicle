...
export const dashboardAPI = {
  ...
  getVehicleStats: async () => {
    return await fetchWithErrorHandling(API_ENDPOINTS.DASHBOARD.VEHICLE_STATS);
  },

  // Get daily work hours
  getDailyWorkHours: async () => {
...
export const vehiclesAPI = {
  ...
  getAllVehicles: async () => {
    const data = await fetchWithErrorHandling(API_ENDPOINTS.VEHICLES.BASE);
...
export const odometerAPI = {
  ...
  getOdometerDataBothModes: async (vehicleId) => {
    try {
      ...
      console.error('Error fetching odometer data:', error);
      return {
        strict: [],
        nonStrict: []
      };
